...
function collectData(id){var elementList=document.getElementById(id).querySelectorAll('input, select, textarea');var pair={};_babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_0___default()(elementList).call(elementList,function(element){var type=element.getAttribute("type");if(type==='checkbox'||type==='radio'){pair[element.name]=element.checked;}else{pair[element.name]=element.value;}});console.log(pair);return pair;}
}();
/******/ })()
;