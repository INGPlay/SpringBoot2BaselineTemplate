 ...
 */function requestJsonAjaxPromise(object){var _object$method,_object$type;object.dataType="json";object.contentType='application/json';if(((_object$method=object.method)===null||_object$method===void 0?void 0:_object$method.toLowerCase())!=='get'&&((_object$type=object.type)===null||_object$type===void 0?void 0:_object$type.toLowerCase())!=='get'){if(object.data){object.data=_babel_runtime_corejs3_core_js_stable_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(object.data);}}return requestAjaxPromise(object);}/**
 * JSON 통신
 ...
 *    data : {json object}
 * @returns {Promise<unknown>}
 */function requestJsonAjaxPromiseV2Form(object){var _object$method2,_object$type2;object.dataType="json";object.contentType='application/json';if(((_object$method2=object.method)===null||_object$method2===void 0?void 0:_object$method2.toLowerCase())!=='get'&&((_object$type2=object.type)===null||_object$type2===void 0?void 0:_object$type2.toLowerCase())!=='get'){if(object.data){object.data=_babel_runtime_corejs3_core_js_stable_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(object.data);}}return requestAjaxPromiseResponseForm(object);}/**
 * Image 통신
 * @param object
 *    url : {url},
 *    method : {Http method},
 *    data : {FormData}
 * @returns {Promise<unknown>}
 */function requestMultipartAjaxPromise(object){object.dataType="json";object.enctype="multipart/form-data";object.contentType=false;object.processData=false;return requestAjaxPromise(object);}function requestAjaxPromise(object){return new (_babel_runtime_corejs3_core_js_stable_promise__WEBPACK_IMPORTED_MODULE_1___default())(function(resolve,reject){$.ajax(object).done(function(response){resolve(response);}).fail(function(error){reject(error);}).always(function(){});});}/**
 * response -> response.data
 * error -> error.responseJSON.data
 * @param object
 * @returns {Promise<unknown>}
 */function requestAjaxPromiseResponseForm(object){return new (_babel_runtime_corejs3_core_js_stable_promise__WEBPACK_IMPORTED_MODULE_1___default())(function(resolve,reject){$.ajax(object).done(function(response){resolve(response.data);}).fail(function(error){reject(error.responseJSON.data);}).always(function(){});});}/**
 * select 옵션 추가
 ...
 * @param id
 * @param object
 */function requestSelectOption(selector,object){requestJsonAjaxPromise(object).then(function(response){var _context;_babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_2___default()(_context=document.querySelectorAll(selector)).call(_context,function(element){if(element.options.length<=1){var _context2;_babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_2___default()(_context2=response.data.contents).call(_context2,function(data){var optionElement=document.createElement("option");optionElement.text=data.text;optionElement.value=data.value;element.appendChild(optionElement);});}});})["catch"](function(error){alert("옵션을 가져오지 못하였습니다.");});}
}();
/******/ })()
;